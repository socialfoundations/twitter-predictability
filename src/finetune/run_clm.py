...
class DataTrainingArguments:
    ...
    artifact_name: Optional[str] = field(
        default=None, metadata={"help": "Name of the wandb dataset artifact."}
    )
    ...
    def __post_init__(self):
        ...
        if (
            ...
            and self.artifact_name is None
        ):
            raise ValueError(
                "Need either a wandb artifact, a dataset name or a training/validation file."
            )
        else:
...
def main():
    ...
    if data_args.dataset_name is not None:
        ...
        if data_args.train_file is not None:
            ...
            file_name = os.listdir(artifact_dir)[
                0
            ]  # get first file from artifact directory
